...
public class Don_t_Keep_Calm__JUST_GIVE_UP__ extends PApplet {
...
public void setup() {
  ...
  cp5.setColorForeground(0xff0fbff5);
  cp5.setColorBackground(0xff1f1f1f);
  cp5.setFont(font);
  cp5.setColorActive(0xff75f8ff);
...
public void draw() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Don_t_Keep_Calm__JUST_GIVE_UP__" };
    if (passedArgs != null) {
