...
def game4():
    ...
    pic2 = Pic(round(ScreenWidth/1080*720), ScreenHeight-(round(ScreenHeight/720*15+round(ScreenHeight/720*30))))
    pic3 = Pic(round(ScreenWidth/1080*820), ScreenHeight-(round(ScreenHeight/720*15+round(ScreenHeight/720*30))))
